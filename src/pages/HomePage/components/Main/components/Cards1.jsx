...
const Cards1 = () => {
  return (
    <div className="rounded-lg max-w-[340px] max-h-[550px] px-2 py-2 border border-gray-700 my-2 bg-[#f0f0ff] cursor-default relative">
      <div>
        <img
        ...
        <p className="text-center text-gray-600 py-2 ">
          ...
          cum ipsum rerum quisquam in ea doloribus expedita reiciendis sapiente?
          Cumque quos illo ea doloribus expedita reiciendis sapiente?
          Cumque quos illo
        </p>
      </div>
